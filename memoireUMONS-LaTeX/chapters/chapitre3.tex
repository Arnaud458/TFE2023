...
\hline
Set \# & BW & SF & Device & SR & SNR \\
\hline
1 & 125 & 7 & 1 & 2 MHz & High \\
2 & 250 & 7 & 1 & 2 MHz & High \\
...
La table \ref{signature} montre pour chaque set de la table \ref{set} si il est possible de pouvoir identifier l'appareil émetteur selon la méthode de l'article. La table fournit  également des informations supplémentaires.

\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|c|c|}
\hline
Set \# & signature identifiable & position de la signature & forme de la signature & cluster possible ?\\
\hline
1 & oui & variable & image & non \\
2 & oui & variable & image & non \\
% Add more rows here as needed
\hline
\end{tabular}
\caption{Table of parameters}
