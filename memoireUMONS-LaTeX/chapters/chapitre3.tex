...
L'équation \ref{eq4005} peut donc être directement appliquées sur les données. Pour rappel, les signaux sont convervés dans des fichiers sous forme d'échantillons I/Q. La dernière inconnue reste l'intervalle différentiel $n$. Il représente le nombre de points échantillonnés pour chaque symbole de LoRa. Il peut être calculé par :
