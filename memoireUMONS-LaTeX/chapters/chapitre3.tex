...
La table \ref{signature} montre pour chaque set de la table \ref{set} si il est possible de pouvoir un cluster de point pour chaque set de paramètre défini à la table \ref{set}. La table fournit  des informations concernant la position et la forme de la signature si cette dernière est identifiable.
