...
application : récupérer les samples I/Q du signal n ayant au préalable "clean" le signal. plot des échantillons dans le plan carthésien. besoin de faire du clustering : calculer la valeur de density maximale. ensuite conserver 0.95 de cette valeur avec dégradé de couleur. 