...
\caption{Répartition des centres des signaux normalisés}\label{term319}
\end{figure}
...
La table \ref{set} donne tout les set qui ont été testés. 

\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
Set \# & Device & BW & SF & SR & qualité du signal & \# d'échantillons \\
\hline
1 & RN2483 \#1 & 125kHz & 7 & 2 MHz & High & 25\\
\hline
2 & RN2483 \#1 & 125kHz & 8 & 2 MHz & High & 25\\
\hline
3 & RN2483 \#1 & 125kHz & 9 & 2 MHz & High & 25\\
\hline
4 & RN2483 \#1 & 125kHz & 10 & 2 MHz & High & 25\\
\hline
5 & RN2483 \#1 & 125kHz & 11 & 2 MHz & High & 25\\
\hline
6 & RN2483 \#1 & 125kHz & 12 & 2 MHz & High & 25\\
...
La table \ref{signature} montre pour chaque set de la table \ref{set} si il est possible de pouvoir identifier l'appareil émetteur selon la méthode de l'article. La table fournit  des informations concernant la position et la forme de la signature si cette dernière est identifiable.

\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|c|c|}
\hline
Set \# & identifiable & position & forme & cluster possible\\
\hline
...
\hline
\end{tabular}
\caption{Table des caractéristiques de la signature pour chaque set}
\label{signature}
\end{table}
